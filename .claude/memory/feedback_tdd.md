...
**How to apply:** For every new dataclass, function, or refactoring step: (1) write failing tests, (2) implement, (3) verify the relevant tests pass. Never skip the test-first step.
