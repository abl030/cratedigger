---
name: User profile
description: User is a senior dev who runs a curated music pipeline on NixOS, prefers TDD and incremental refactoring
type: user
---
...
- Infrastructure: NixOS flakes, PostgreSQL pipeline DB, virtiofs shared storage
