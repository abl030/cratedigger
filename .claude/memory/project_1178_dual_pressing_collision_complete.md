...
**How to apply:** residuals live in #1196 (attempt-fingerprint scoping for the conflict join, guard-skip forensics marker, composite-warning carve-out). Orchestration shape that worked: [[opus-for-reviews]] with sonnet implementers, three review rounds, each round's false-docstring claim caught only by the next independent read — the existing no-round-catches-its-own-claims rule earned its keep three times.
