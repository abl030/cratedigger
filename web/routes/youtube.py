...
ROUTES: list[RouteRegistration] = [
    route(
        ...
        "false, \"watch_url\": \"https://www.youtube.com/watch?v=...&list=...\"}. "
        "The optional public video or playlist URL replaces the complete "
        "cached matrix; list selects the full ordered playlist. "
