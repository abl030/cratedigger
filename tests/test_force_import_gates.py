...
and ``tests/test_integration_slices.py``. The remaining tests here cover
the pure ``lib.preimport`` helpers (``inspect_local_files``,
``run_preimport_gates``, ``repair_mp3_headers``) that both preview and
auto-import still use.
"""
