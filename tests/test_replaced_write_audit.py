...
_REVIEWED_DYNAMIC_SQL_CALLS: dict[tuple[str, int, str], str] = {
    ...
    ("lib/beets_db.py", 868, "4b59d19eb8727dff"): (
        ...
        "and the query is a read-only SELECT. (Issue #1241 added the shared "
        "library-completeness projection constants above BeetsDB, shifting "
        "this line; fingerprint unchanged, confirming the SQL is untouched)"
    ),
