...
_REVIEWED_DYNAMIC_SQL_CALLS: dict[tuple[str, int, str], str] = {
    ...
    ("lib/pipeline_db/download_log.py", 321, "cba0d6d56f1878ac"): (
    ...
    ("lib/pipeline_db/download_log.py", 700, "6eec03e4d024acdb"): (
    ...
    ("lib/pipeline_db/download_log.py", 765, "e0154e89026dc8ef"): (
        "validation key is selected from a closed server-owned vocabulary "
        "(issue #835 and issue #829 PR4 shifted this line only)"
    ),
    ("lib/pipeline_db/download_log.py", 783, "13517e08e7db52f3"): (
        "validation key is closed vocabulary and IN list is value placeholders "
        "(issue #835 and issue #829 PR4 shifted this line only)"
    ),
    ("lib/pipeline_db/download_log.py", 800, "d87a36ba1d1768e7"): (
