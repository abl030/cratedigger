...
assertEqual(qualityLabel('Opus', 192), 'OPUS 192k', 'Opus never borrows MP3 V-level names');
assertEqual(qualityLabel('AAC', 256), 'AAC 256k', 'AAC never borrows MP3 V-level names');
assertEqual(qualityLabel('Vorbis', 192), 'VORBIS 192k', 'Vorbis uses its native codec label');
assertEqual(qualityLabel('WMA', 256), 'WMA 256k', 'WMA uses its native codec label');
...
assertEqual(qualityLabelShort('Vorbis', 192), 'V 192', 'Vorbis -> V');
assertEqual(qualityLabelShort('WMA', 256), 'WM 256', 'WMA -> WM');
