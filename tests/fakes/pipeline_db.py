    ...
    def record_unfindable_run_metrics(
        ...
        *,
        ...
        row = UnfindableRunMetricsRow(
            ...
            probes_attempted=int(probes_attempted),
            categorised_count=int(categorised_count),
            downgraded_count=int(downgraded_count),
            no_change_count=int(no_change_count),
            probe_failed_count=int(probe_failed_count),
            not_due_count=int(not_due_count),
            request_not_found_count=int(request_not_found_count),
