...
**Secrets**: `/var/lib/cratedigger/beets/secrets.yaml` (service-only 0400, or explicit operator-group 0440 via `services.cratedigger.beets.package.discogsOperatorGroup`; materialized from `discogsTokenFile` and included via beets `include:`)
