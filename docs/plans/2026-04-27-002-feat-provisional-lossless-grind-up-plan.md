...
- Pure decision layer: [lib/quality/pipeline.py](lib/quality/pipeline.py)
- Preimport gates: [lib/measurement.py](lib/measurement.py)
- Dispatch side effects: [lib/dispatch/core.py](lib/dispatch/core.py)
- Pipeline persistence: [lib/pipeline_db/__init__.py](lib/pipeline_db/__init__.py)
