...
-- evidence during preview" work: they cover 6 evidence rows measured
-- 07:32-07:58 on 2026-07-31 (+0800), around that revision's own commit
-- (5e05e5e7, 07:17) and revert (13ed134f, 07:50).
--
-- The three readers of this table -- lib/pipeline_db/evidence.py,
-- lib/pipeline_db/download_log.py, scripts/decision_differential.py -- all
-- name their columns explicitly, so nothing selects it even implicitly.
--
