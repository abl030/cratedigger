...
If a future design decision drifts toward "good enough" matches, "smart" defaults, or auto-throttling apparently-dead requests, that drift is a bug. Push back.
